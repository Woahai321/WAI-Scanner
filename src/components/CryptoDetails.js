      ...
      >
        {data ? (
          <div className="flex md:flex-row flex-col items-center justify-between lg:h-full h-auto w-full p-4 relative">
            <div className="flex flex-col  md:w-[45%] w-full h-full pr-2">
                    ...
                    <div
                      className={`text-sm px-1 ml-2 font-medium flex items-center ${
                        Number(data.market_data.price_change_percentage_24h) > 0
                          ? "bg-green text-green"
                          : "bg-red text-red"
                      } rounded bg-opacity-25 uppercase`}
                    >
                      <span>
                        {Number(
              ...
              <div className="flex w-full  mt-4 justify-between sm:flex-row flex-col">
                ...
                <div className="flex flex-col content-start sm:mt-0 mt-1">
                  ...
                  <div
                    className={`text-sm px-1 my-1 font-medium flex items-center bg-green text-green rounded bg-opacity-25 uppercase`}
                  >
                    <span>
                  ...
                  <div
                    className={`text-sm px-1 my-1 font-medium flex items-center bg-red text-red rounded bg-opacity-25 uppercase`}
                  >
                    <span>
            ...
            <div className="flex flex-col justify-between md:justify-start md:w-[55%] w-full h-[60vh] md:pl-4 pl-0 md:mt-0 mt-2">
              <Chart id={data.id} />
          ...
          <div className="w-full h-full flex justify-center items-center">
            <span className="text-base text-red ml-2">
              {error.coinData
                ? error.coinData
